...
public class DatabaseManager {
    ...
    public void createTestData() {
        entityManager.createNativeQuery(createProducts()).executeUpdate();
        entityManager.createNativeQuery(createRecipes()).executeUpdate();
        entityManager.createNativeQuery(createRecipeProducts()).executeUpdate();
    }
